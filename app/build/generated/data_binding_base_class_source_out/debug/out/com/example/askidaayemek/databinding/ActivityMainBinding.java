...
public final class ActivityMainBinding implements ViewBinding {
  ...
  @NonNull
  public final BottomNavigationView butonNavigasyon;
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.butonNavigasyon;
      BottomNavigationView butonNavigasyon = ViewBindings.findChildViewById(rootView, id);
      if (butonNavigasyon == null) {
        break missingId;
      }

      id = R.id.fragmentKonteynrView;
      FragmentContainerView fragmentKonteynrView = ViewBindings.findChildViewById(rootView, id);
      if (fragmentKonteynrView == null) {
        break missingId;
      }
